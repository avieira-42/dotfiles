...
opts = {
	format_on_save = function(bufnr)
		local disable_filetypes = { lua = true, javascript = true } -- add what you don’t want
...
vim.api.nvim_create_autocmd({ 'ColorScheme', 'BufWinEnter', 'BufReadPost' }, {
	...
	vim.cmd ':nmap <Space>t :vert ter'
	vim.cmd ':nmap <Space>r :%s//'
	vim.cmd ':nmap <Space>rl :*:s//r/g'
	vim.cmd ':nmap <Space>f :vs . <Enter>'
	vim.cmd ':nmap <Space>u :UpdateTypesFile <Enter>'
