...
vim.keymap.set("n", "<leader>a", mark.add_file) -- set a newfile for the harpoon
vim.keymap.set("n", "<C-h>", ui.toggle_quick_menu) -- open harpoon quickview window

-- open respective file through harpoon number
